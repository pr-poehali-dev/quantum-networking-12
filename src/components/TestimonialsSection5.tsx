...
const testimonials = [
  {
    quote: "Заказываю уже третий раз — всё оригинальное, упаковка шикарная. Доставили за день! Пробники в подарок тоже очень приятный бонус.",
    author: "Мария Соколова",
    role: "Постоянный покупатель",
    image: "https://i.pravatar.cc/150?img=47",
  },
  {
    quote: "Попросила помочь с выбором подарка мужу — эксперт подобрал идеальный вариант. Муж в восторге, теперь и сам заказывает здесь!",
    author: "Екатерина Новикова",
    role: "Покупатель из Москвы",
        ...
        <div className="flex flex-col gap-12">
          <div className="flex flex-col gap-4 md:gap-5 max-w-xl text-center md:text-left">
            ...
            <h2 id="testimonial-title" className="text-3xl md:text-4xl font-bold">
              Нас уже выбрали тысячи покупателей
            </h2>
          </div>
